...
public class OfflieFolderListigActivity extends Activity implements
		OnClickListener {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			rowView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					nextPage = new Intent(context,
							OfflineFileListingActivity.class);
					nextPage.putExtra("courseFolderName", textViewFolderName
							.getText().toString());
