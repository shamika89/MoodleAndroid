...
public class WebServiceCommunicator extends
		AsyncTask<Object, Object, JSONObject> {
	...
	protected JSONObject doInBackground(Object... params) {
		...
		try {
			...
			TransformerFactory transFact = TransformerFactory.newInstance(); // transform
																				// XML
																				// to
																				// JSon.
			...
			// Toast.makeText(context, "Error web service request",
			// Toast.LENGTH_SHORT).show();
			Log.d("WebServiceCommunicator", "MalFunc exception" + e.toString()); // writing
																					// exception
																					// to
																					// log
			e.printStackTrace();
			...
			Log.d("WebServiceCommunicator",
					"TransformConfig exception" + e.toString());
			e.printStackTrace();
		} catch (TransformerException e) {
			Log.d("WebServiceCommunicatorr",
					"Transformer exception" + e.toString());
			e.printStackTrace();
	...
	protected void onPostExecute(JSONObject jsonObject) {
		...
		if (function.equals(WebserviceFunction.moodle_webservice_get_siteinfo)) {
			...
			try {
				...
				.equals(WebserviceFunction.moodle_enrol_get_users_courses)) {
			try {
